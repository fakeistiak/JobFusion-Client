    ...
    <div>
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="w-full max-w-md bg-white rounded-lg shadow-md p-8">
          <h2 className="lg:text-4xl md:text-4xl text-3xl font-bold text-center mb-6 text-sky-600">Login</h2>
        <h2 className="text-2xl font-bold text-center mb-6">
          ...
          <form onSubmit={handleRegister}>
            ...
            <p className="py-4 text-lg text-center">New to JobFusion? <a className="text-sky-600" href="/register">SignUp</a> </p>
          </form>
        </div>
      </div>
    </div>
